...
> **Note on file number**: Due to the total number of all files beeing **8,335**, only a small selection of example files is included in this repository. The complete set can be generated by running the script `R/05_calculation_evaluation_metrics.R`. All data in these files is also available in the `data/resultsImbalanced/results.RDS`file.
