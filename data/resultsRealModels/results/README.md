# README – Result files real models

## Overview

This folder contains 41,437 `.RDS` files. Each file is a serialized R data frame representing the performance evaluation of a species distirbution map, generated with a machine learning model, with several evaluation metrics.
...
| **model** | The modeling algorithm used (e.g., `BRT`, `RF`, `GAM`, `Maxent` or `Lasso`) |
...
| **MODEL** | `BRT` | **Model Type**: Placeholder for the algorithm. `BRT`, `RF`, `GAM`, `Maxent` or `Lasso` |
